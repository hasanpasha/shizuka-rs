...
use crate::model::{Media, MediaKind, Medias, Seasons, Subtitles, Videos};
...
pub trait Source {
    fn search(
        ...
        kind: MediaKind,
        page: Option<u32>,
    ) -> impl Future<Output = SourceResult<Medias>> + Send;
    ...
    // fn get_info(&self, media: &Media) -> impl Future<Output = SourceResult<Subtitles>> + Send;
}
